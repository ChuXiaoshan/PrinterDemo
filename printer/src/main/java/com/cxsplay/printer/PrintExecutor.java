...
public class PrintExecutor {
     ...
     * @return 错误代码
     */
    public int doPrinterRequest(com.cxsplay.printer.PrintDataMaker maker) {
     ...
     * 异步执行打印请求
     */
    public void doPrinterRequestAsync(com.cxsplay.printer.PrintDataMaker maker) {
     ...
     */
    public InputStream getInputStrecxsplay() throws IOException {
    ...
    private class PrintTask extends AsyncTask<com.cxsplay.printer.PrintDataMaker, Integer, Integer> implements
        ...
        @Override
        protected Integer doInBackground(com.cxsplay.printer.PrintDataMaker... makers) {
